    ...
    <div id="toolbar" class="param-container tool-bar">
      <div class="element" id="colorTable" title="设置颜色表">
        <select class="selectpicker">
          ...
          <option
            value="2"
            data-content="<span class='label band2'>&nbsp</span>"
            >&nbsp</option
          >
          <option
            value="3"
            data-content="<span class='label band3'>&nbsp</span>"
            >&nbsp</option
          >
          <option
            value="4"
            data-content="<span class='label band4'>&nbsp</span>"
            >&nbsp</option
          >
          <option
            value="5"
            data-content="<span class='label band5'>&nbsp</span>"
            >&nbsp</option
          >
        </select>
      </div>
